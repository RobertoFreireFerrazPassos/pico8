...
s = class:new({
	...
	control=function(_ENV)
		...
		if not addedtower and btn(5) then
			add(towers,t:new({x=x,y=y}))
			addedtower=true
			timemanager:addtimer(15,function() s.addedtower=false end,1)
		end
	end,
	draw=function(_ENV)
		spr(1,x,y)
...

